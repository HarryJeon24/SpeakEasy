...
def visits() -> DialogueFlow:
    ...
    health_transitions = {
        'state': 'health',
        '`I hear you. I like` $TOPIC` everyday, along with other enjoyable activities because it is important to have balance. Would you say you have a healthy lifestyle?`': {
            '#SET_LIFESTYLE #GET_LIFESTYLE': {
                ...
                '`Aww. I know how hard it is to balance everything. What do you think you need to work on the most?`': {
                    ...
                    '#SET_BALANCE': {
                        '#GET_BALANCE': {
                            'error': {
                                '`I hear you. I usually cope with my everyday stressors by treating myself with yummy food`': {
                                    'error': 'food'
                                }
                            }
                        }
    ...
    food_transitions = {
        'state': 'food',
        '`Ahh. I usually like to eat pretty healthy, so my favorite place to grab a bite to eat is Cava. What\'s your fav place to eat at?`': {
            '#SET_FOOD': {
                '#GET_FOOD': {
                        ...
                        '`You should make sure to eat whole foods like fruits and veggies, without giving up the other foods you enjoy. Have you seen the show, Vegucated?`': {
                            ...
                            'error': {
                                '`It\'s one of my favorites! It\'s surprisingly funny and it really emphasizes the importance of eating foods that fuel you.`': {
                                    'error': {
                                        '`While we are on the topic, why don\'t you tell me more about the kinds of movies/shows you like to watch?`': {
                                            'error': 'entertainment'
                                        }
                                    }
                                }
...
def get_topic(vars: Dict[str, Any]):
    ...
    vars['TOPIC'] = topic
    if vars['TOPIC'] == "nothing" or vars['TOPIC'] == "not much" or vars['TOPIC'] == "nothing much":
        vars['TOPIC'] = "relaxing"
